      ...
      <div className="intro" style={{backgroundColor: is_dark && "black"}}>
        ...
        className="left_intro">
          ...
          <div className="info">
            ...
            className="hire_me_container">
             <motion.button 
             whileHover={{scale: 0.8}}
             whileTap={{rotate: -25, scale: 1}}
             transition={{duration: 0.1, }}
             className="hire_me_button"> Hire me </motion.button>
            </motion.div>
          
            <div className="icons"> 
              <div className="contain_icons">
                <a href= "https://github.com/Abdulrafiudev" target = "blank"> <img src={github}></img> </a>
                <a href= "https://www.instagram.com/abdul.rafiu_._/" target = "blank"> <img src={instagram}></img> </a>
                <a  href= "https://www.linkedin.com/in/abdulrafiudev/" target = "blank"> <img src={linkedin}></img> </a>
        ...
        className="right_intro">
            ...
            <AnimatePresence>
              ...
              transition={{duration:1.5, ease: "backOut"}}
                ...
                src = {glasses_imoji} className="glass_imoji"></motion.img>
